            ...
            if(mysqli_num_rows($result) > 0) {
                while($fetch = mysqli_fetch_array($result)) {
                    ...
                    if ($link_locandina != "locandina_default.png") {
                        ...
                        echo "<img src='".$file_icon."' align='center' height='30' style='margin-right: 15px;'>".$link_locandina." <a style='margin-left: 25px;' href='files/".$link_locandina."' class='material-icons' download>download</a> <a style='margin-left: 25px;' href='files/".$link_locandina."' class='material-icons' target='_blank'>visibility</a>";
                    }
