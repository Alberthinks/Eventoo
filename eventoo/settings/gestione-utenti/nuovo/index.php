    ...
    <body>
        ...
        if ($_SESSION['session_permessi_eventoo'] == "maintenance" || $_SESSION['session_permessi_eventoo'] == "administration") {
            if (isset($_POST['submit']) && $_POST['submit']=="Registra utente") {
                ...
                $sql = "INSERT INTO users (nome,cognome,ao,username,password,foto,permessi,last_access) VALUES ('$nome', '$cognome','$ao','$username','$passuord','$logo','$permessi','$last_access')";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <input type="radio" name="permessi" id="maintenance_permesso"> <label for="maintenance_permesso">Manutenzione (lettura, scrittura e accesso alle impostazioni di manutenzione della piattaforma)</label><br>
            ...
            <label for="logo" class="label2">Foto profilo:</label>
