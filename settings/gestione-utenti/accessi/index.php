...
<html lang="it">
    <head>
        ...
        <style>
            ...
            select {height: 48px; width: 310px;}
            select, input {margin-left: 20px;}
        </style>
    </head>
    <body>
        <?php
        ...
        <div style="display: flex;">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <input type="submit" name="truncate" value="Svuota lista" style="padding: 0; background: red; color: #fff; border: none;">
            </form>

            <select id="actionFiltering" onchange="filtraAttivita(5,'actionFiltering')">
                <option value=""></option>
                ...
                <option value="Foto profilo modificata">Modifica foto profilo</option>
            </select>
        ...
        <script>
            function setTimestamp() {
                ...
                filtraAttivita(6,'timestampFiltering');
            }
        </script>
