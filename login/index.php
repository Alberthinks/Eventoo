...
<body>
	...
	<form name="enter" method="post" action="login.php" enctype="application/x-www-form-urlencoded">
		...
		<div class="inputGroup inputGroup1">
			...
			<input type="text" id="loginEmail" name="username" maxlength="254" />
			<p class="helper helper1">nome.cognome</p>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="loginPassword" id="loginPasswordLabel">Password</label>
			<input type="password" id="loginPassword" name="password" />
			<label id="showPasswordToggle" for="showPasswordCheck">Mostra password
	...
	<script src="js/NextgenmediaSVGPlugin.min_2.js"></script>
