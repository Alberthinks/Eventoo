            ...
            <div class="main_container">
                <div class="left_content">
                    ...
                    <div class="right_content">
                        ...
                        <input style="margin-top: 60px; accent-color: #db0d0d;" type="checkbox" name="chiusura" id="chiusura" onchange="chiusuraScuola()">
                        <label for="chiusura" style="color: #db0d0d; margin-left: 10px; font-weight: bold;">Sospensione delle lezioni/chiusura della scuola (festivit&agrave;, vacanze, ponti)</label>
                        <script>
